...
//                ->required()
            ...
            Forms\Components\TextInput::make('configuration.stormproxies.port')
                ->default('1000')
                ->helperText('端口'),
            
            Forms\Components\Select::make('configuration.stormproxies.protocol')
                ->options([
                    'http'   => 'HTTP/HTTPS',
                    // 'socks5' => 'SOCKS5',
                ])
            ...
            Forms\Components\TextInput::make('configuration.stormproxies.area')
            ...
            Forms\Components\Toggle::make('configuration.stormproxies.sticky_session')
            ->label('启用粘性会话')
            ...
            Forms\Components\TextInput::make('configuration.stormproxies.life')
...
//                ->required()
    ...
    protected static function getIproyalSchema(): array
    {
        return [
            ...
            Forms\Components\TextInput::make('configuration.iproyal.city')
